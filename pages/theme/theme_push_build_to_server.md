...
permalink: theme_push_build_to_server.html
folder: theme
---
...
```
aws s3 cp ~/users/tjohnson/projects/themeproject/ s3://[aws path]docpath/themeproject --recursive
...
```
scp -r /users/tjohnson/projects/themeproject/ name@domain:/var/www/html/themeproject
```
