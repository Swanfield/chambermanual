...
permalink: theme_yaml_tutorial.html
folder: theme
---
...
In the \_data/theme folder, there's a file called samplelist.yml. All of these examples come from that file.
...
Notice that in order to access the data file, you use `site.data.samplelist`. `theme` is the folder, and `samplelist` is the name of the YAML file.
