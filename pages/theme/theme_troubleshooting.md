...
permalink: theme_troubleshooting.html
folder: theme
---
...
If you run into permissions errors trying to run a shell script file (such as theme_multibuild_web.sh), you may need to change the file permissions to make the sh file executable. Browse to the directory containing the shell script and run the following:
