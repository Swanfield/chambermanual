...
permalink: theme_hyperlinks.html
folder: theme
---
...
```yaml
    - title: Some link bookmark
      url: /theme_pages.html#someIdTag
```

And reference it like this:

```
This is [Some link][theme_pages.html#someIdTag].
```
